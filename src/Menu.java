...
public class Menu extends JFrame {
	...
	private Image img_logo = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\profile.png").getImage().getScaledInstance(150,150,Image.SCALE_SMOOTH);
	private Image img_home = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\home.png").getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	private Image img_parametre = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\parametre.png").getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
	private Image img_vote = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\vote.png").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH);
	private Image img_prog = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\text.png").getImage().getScaledInstance(70,70,Image.SCALE_SMOOTH);
	private Image img_stat = new ImageIcon("C:\\Users\\bapti\\OneDrive\\Documents\\TP1_IT\\projet\\DemocratieAPP\\src\\Ressource\\stat.png").getImage().getScaledInstance(40,40,Image.SCALE_SMOOTH);
